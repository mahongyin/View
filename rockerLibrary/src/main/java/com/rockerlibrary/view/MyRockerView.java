package com.rockerlibrary.view;
...
public class MyRockerView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MyRockerView);

        // 可移动区域背景
        Drawable areaBackground = typedArray.getDrawable(R.styleable.MyRockerView_areaBackground);
        ...
        // 摇杆背景
        Drawable rockerBackground = typedArray.getDrawable(R.styleable.MyRockerView_rockerBackground);
        ...
        // 摇杆半径
        mRockerRadius = typedArray.getDimensionPixelOffset(R.styleable.MyRockerView_rockerRadius, DEFAULT_ROCKER_RADIUS);
